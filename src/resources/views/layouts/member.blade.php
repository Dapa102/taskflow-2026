        ...
        <aside class="taskflow-sidebar">
            ...
            <nav class="flex-1 overflow-y-auto px-3 py-3 space-y-0.5">
                ...
                <a href="{{ route('member.tasks') }}"
                   class="sidebar-link {{ request()->routeIs('member.tasks*') ? 'active' : '' }}">
                ...
                <a href="{{ route('member.teams') }}"
                   class="sidebar-link {{ request()->routeIs('member.teams') ? 'active' : '' }}">
                ...
                <a href="{{ route('member.my-workspaces') }}"
                   class="sidebar-link {{ request()->routeIs('member.my-workspaces') ? 'active' : '' }}">
                ...
                <a href="{{ route('profile.edit') }}"
                   class="sidebar-link">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z"/></svg>
                    Profil
                </a>
            </nav>
            ...
            <div class="border-t border-border p-3 shrink-0">
                <div class="flex items-center gap-3 px-2 py-1.5">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="text-xs text-text-secondary truncate">Anggota</div>
                    </div>

    ...
    <div class="min-h-screen flex bg-gray-100">
        <aside class="w-72 bg-white border-r border-gray-200 flex flex-col h-screen sticky top-0">
            ...
            <nav class="flex-1 overflow-y-auto px-4 pt-4 pb-2 space-y-1">
                ...
                <a href="{{ route('super-admin.pm-performance') }}"
                   class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium {{ request()->routeIs('super-admin.pm-performance') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-700 hover:bg-gray-100' }}">

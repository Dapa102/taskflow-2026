                        ...
                        <div class="space-y-2 min-w-[160px]">
                            @foreach($chartData as $item)
                                <div class="flex items-center gap-2">
                                    ...
                                    <button x-data @click="$wire.showDetail('{{ $item['label'] }}')" class="legend-btn p-1 text-gray-400 hover:text-indigo-600 transition cursor-pointer" title="Lihat detail" type="button">

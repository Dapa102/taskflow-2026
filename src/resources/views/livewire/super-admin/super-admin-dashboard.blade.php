        ...
        <div class="max-w-7xl mx-auto space-y-6">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div class="bg-white rounded-xl shadow-sm p-5 border border-gray-200">
                    <p class="text-sm text-gray-500 font-medium">Workspace</p>
                    <p class="text-3xl font-bold text-gray-900 mt-1">{{ $workspaceCount }}</p>
                </div>
                <div class="bg-white rounded-xl shadow-sm p-5 border border-gray-200">
                ...
                <div class="bg-white rounded-xl shadow-sm p-5 border border-gray-200">
                    <p class="text-sm text-gray-500 font-medium">PM</p>
                    <p class="text-3xl font-bold text-purple-600 mt-1">{{ $pmCount }}</p>
                </div>
                <div class="bg-white rounded-xl shadow-sm p-5 border border-gray-200">
                    <p class="text-sm text-gray-500 font-medium">Member</p>
                    <p class="text-3xl font-bold text-indigo-600 mt-1">{{ $memberCount }}</p>
                </div>
                <div class="bg-white rounded-xl shadow-sm p-5 border border-gray-200">

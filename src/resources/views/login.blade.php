    ...
    <div class="relative w-full max-w-md">
        <div id="login-card" class="bg-zinc-900/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-zinc-800/60 p-8 md:p-10 animate-fadeIn">
            ...
            <div class="text-center mb-8">
                <div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl shadow-lg shadow-blue-500/25 mb-4">
                ...
                <p class="text-zinc-400 text-sm mt-1.5">Sign in to your TaskFlow account</p>
            </div>
